...
class EditHistorialClinico extends StatefulWidget {
  const EditHistorialClinico({super.key, required this.idHistorial});
  final int idHistorial;
  @override
  State<EditHistorialClinico> createState() => _EditHistorialClinicoState();
}

class _EditHistorialClinicoState extends State<EditHistorialClinico> {
  ...
  void initState() {
    ...
    HistoriaClinicaController()
        .getHistoriaClinicaDoc(widget.idHistorial)
        .then((value) async {
      setState(() {
        var historial = value;
        if (kDebugMode) {
        ...
        manifestaciones = historial['manifestaciones'];
        fechaRegString = historial['fechaRegistro'];
        estadoPaciente = historial['estadoPaciente'];
        idExp = historial['idExpediente'];
        idAdmin = historial['idAdministrativo'];
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: ElevatedButton(
                        ...
                        child: const Text('Editar Historial Clinico')),
                  )
                ],
              ),
            ),
